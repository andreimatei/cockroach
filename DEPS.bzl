...
def go_deps():
    ...
    go_repository(
        ...
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/github.com/andreimatei/opentelemetry-proto/com_github_andreimatei_opentelemetry_proto-v0.0.0-20220624212849-7201f6685a7a.zip",
        ],
    )
    go_repository(
