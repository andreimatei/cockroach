...
var logicTestConfigs = []testClusterConfig{
	...
	{name: "local-v2.2.alpha@v2.1-noupgrade", numNodes: 1,
		bootstrapVersion: &cluster.ClusterVersion{
			UseVersion:     cluster.VersionByKey(cluster.Version2_1),
			MinimumVersion: cluster.VersionByKey(cluster.Version2_1),
		},
		serverVersion:  cluster.VersionByKey(cluster.Version2_2_development_start),
		disableUpgrade: 1,
	},
