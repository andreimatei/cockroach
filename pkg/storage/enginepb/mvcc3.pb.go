...
func (*TxnMeta) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_4248ef00978868c2, []int{0}
}
...
func (*IgnoredSeqNumRange) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_4248ef00978868c2, []int{1}
}
...
func (*MVCCStatsDelta) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_4248ef00978868c2, []int{2}
}
...
func (*MVCCPersistentStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_4248ef00978868c2, []int{3}
}
...
type RangeAppliedState struct {
	...
	// !!! comment
	ClosedTimestampNanos int64 `protobuf:"varint,4,opt,name=closed_timestamp_nanos,json=closedTimestampNanos,proto3" json:"closed_timestamp_nanos,omitempty"`
}
...
func (*RangeAppliedState) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_4248ef00978868c2, []int{4}
}
...
func (*MVCCWriteValueOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_4248ef00978868c2, []int{5}
}
...
func (*MVCCWriteIntentOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_4248ef00978868c2, []int{6}
}
...
func (*MVCCUpdateIntentOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_4248ef00978868c2, []int{7}
}
...
func (*MVCCCommitIntentOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_4248ef00978868c2, []int{8}
}
...
func (*MVCCAbortIntentOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_4248ef00978868c2, []int{9}
}
...
func (*MVCCAbortTxnOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_4248ef00978868c2, []int{10}
}
...
func (*MVCCLogicalOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_4248ef00978868c2, []int{11}
}
...
func (this *RangeAppliedState) Equal(that interface{}) bool {
	...
	if this.ClosedTimestampNanos != that1.ClosedTimestampNanos {
		return false
	}
	return true
}
...
func (m *RangeAppliedState) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ClosedTimestampNanos != 0 {
		dAtA[i] = 0x20
		i++
		i = encodeVarintMvcc3(dAtA, i, uint64(m.ClosedTimestampNanos))
	}
	return i, nil
}
...
func NewPopulatedRangeAppliedState(r randyMvcc3, easy bool) *RangeAppliedState {
	...
	this.RangeStats = *v5
	this.ClosedTimestampNanos = int64(r.Int63())
	if r.Intn(2) == 0 {
		this.ClosedTimestampNanos *= -1
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func (m *RangeAppliedState) Size() (n int) {
	...
	n += 1 + l + sovMvcc3(uint64(l))
	if m.ClosedTimestampNanos != 0 {
		n += 1 + sovMvcc3(uint64(m.ClosedTimestampNanos))
	}
	return n
}
...
func init() {
	proto.RegisterFile("storage/enginepb/mvcc3.proto", fileDescriptor_mvcc3_4248ef00978868c2)
}

var fileDescriptor_mvcc3_4248ef00978868c2 = []byte{
	...
	,
}
