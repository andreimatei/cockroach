...
func (r *Replica) canServeFollowerReadRLocked(
	...
	maxClosed := r.maxClosedRLocked(ctx, requiredFrontier /* sufficient */)
...
func (r *Replica) maxClosedRLocked(ctx context.Context, sufficient hlc.Timestamp) hlc.Timestamp {
