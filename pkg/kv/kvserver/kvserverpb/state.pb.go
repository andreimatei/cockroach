...
type ReplicaState struct {
	...
	//
	// Note that this is a physical timestamp If closed_timestamp_nanos = 10, then
	// a future write at 10,0 won't happen, but one at 10,1 might.
	ClosedTimestampNanos int64 `protobuf:"varint,13,opt,name=closed_timestamp_nanos,json=closedTimestampNanos,proto3" json:"closed_timestamp_nanos,omitempty"`
}
...
func (*ReplicaState) Descriptor() ([]byte, []int) {
	return fileDescriptor_state_083664aa050e8374, []int{0}
}
...
func (*RangeInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_state_083664aa050e8374, []int{1}
}
...
func (*RangeInfo_CTEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_state_083664aa050e8374, []int{1, 0}
}
...
func (*LatchManagerInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_state_083664aa050e8374, []int{2}
}
...
func (m *ReplicaState) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ClosedTimestampNanos != 0 {
		dAtA[i] = 0x68
		i++
		i = encodeVarintState(dAtA, i, uint64(m.ClosedTimestampNanos))
	}
	return i, nil
}
...
func (m *ReplicaState) Size() (n int) {
	...
	if m.ClosedTimestampNanos != 0 {
		n += 1 + sovState(uint64(m.ClosedTimestampNanos))
	}
	return n
}
...
func init() {
	proto.RegisterFile("kv/kvserver/kvserverpb/state.proto", fileDescriptor_state_083664aa050e8374)
}

var fileDescriptor_state_083664aa050e8374 = []byte{
	// 1079 bytes of a gzipped FileDescriptorProto
	,
}
