...
func TestCCLLogic_multi_region_foreign_key_lookup_join(t *testing.T) {
	defer leaktest.AfterTest(t)()
...
func TestCCLLogic_multi_region_locality_optimized_search_query_behavior(t *testing.T) {
	defer leaktest.AfterTest(t)()
...
func TestCCLLogic_regional_by_row_hash_sharded_index_query_plan(t *testing.T) {
	defer leaktest.AfterTest(t)()
...
func TestCCLLogic_regional_by_row_query_behavior(t *testing.T) {
	defer leaktest.AfterTest(t)()
