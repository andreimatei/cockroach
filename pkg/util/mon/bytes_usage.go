...
//
// A BoundAccount instance is not thread-safe. A nil *BoundAccount pointer is a
// no-op: all the operations succeed and it does not track its usage. A nil
// *BoundAccount is thread-safe.
