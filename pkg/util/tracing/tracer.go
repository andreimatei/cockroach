...
const (
	...
	TracingModeOnDemand
	// TracingModeActiveSpansRegistry means that Spans are always created. Open
	// spans are accessible through the active spans registry. If no
...
func NewTracer() *Tracer {
	...
	t.noopSpan = &Span{noop: true, i: spanInner{tracer: t}}
	t.sterileNoopSpan = &Span{noop: true, i: spanInner{tracer: t, sterile: true}}
	return t
}
