...
func registerKV(r registry.Registry) {
	...
	for _, opts := range []kvOptions{
		...
		{nodes: 3, cpus: 8, readPercent: 95, concMultiplier: 1},
		{nodes: 3, cpus: 8, readPercent: 95, concMultiplier: 2},
		{nodes: 3, cpus: 8, readPercent: 95, concMultiplier: 4},
		{nodes: 3, cpus: 8, readPercent: 95, concMultiplier: 8},
		{nodes: 3, cpus: 8, readPercent: 95, concMultiplier: 16},
		{nodes: 3, cpus: 8, readPercent: 95, concMultiplier: 32},
		{nodes: 3, cpus: 8, readPercent: 95, concMultiplier: 64},
		{nodes: 3, cpus: 8, readPercent: 95, concMultiplier: 128},
		{nodes: 3, cpus: 8, readPercent: 95, concMultiplier: 256},
		{nodes: 3, cpus: 8, readPercent: 95, concMultiplier: 512},
